# Mostly self explanatory, this script setups up the layout
# More specifically, layout should not be edited here. This is only
# Where the layouts are ingested from the /layouts folder from the individual
# yaml files. This makes the layouts indipendent from the code
