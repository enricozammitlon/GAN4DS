# This script is used for analysis of the GAN4DS vs G4DS
# It can produce plots of f200 vs S1, log(S2/S1) vs S1
# It also produces permutation tests and Wasserstein distances
# It can also display the actual distributions for all variables learnt, for all
